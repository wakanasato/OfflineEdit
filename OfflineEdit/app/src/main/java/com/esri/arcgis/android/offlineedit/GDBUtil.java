...
//    static final String DEFAULT_FEATURE_SERVICE_URL = "http://services.arcgis.com/hRUr1F8lE8Jq2uJo/ArcGIS/rest/services/AppalachianTrailShelters/FeatureServer";
    ...
    private static void downloadGeodatabase(final OfflineEditorActivity activity, final MapView mapView) {
        ...
        if (!isGeoDatabaseLocal()) {
            // geodatabaseが存在しない場合
            // gdb をゼロから作成するにはjobかな？

            //DLしたいgdbのRESTとユーザ情報(null=credential)を引数にしてgdbtaskを作成
